...
const RetailersPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="flex">
        {/* FILTER SIDEBAR */}
        <div className="w-80 min-h-screen bg-white shadow-lg border-r border-slate-200 px-6 py-8 sticky top-0">
          ...
          <div className="mb-8">
            <div className="relative">
              ...
              <input
                type="text"
                className="block w-full pl-9 pr-4 py-2.5 border border-slate-200 rounded-lg text-sm placeholder-slate-400 focus:outline-none  focus:border-indigo-500 bg-white/50 hover:bg-white transition-colors"
          ...
          <div className="mb-8">
            ...
            >
              Location
              <svg 
                className={`w-4 h-4 text-slate-500 transition-transform duration-200 ${openLocation ? 'rotate-180' : ''}`}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
          ...
          <div className="mb-8">
            ...
            >
              Type
              <svg 
                className={`w-4 h-4 text-slate-500 transition-transform duration-200 ${openType ? 'rotate-180' : ''}`}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            {openType && (
              <div className="mt-3 border rounded-md border-slate-200">
                {types.map((type) => (
                  <div
                    key={type}
                    onClick={() => {
